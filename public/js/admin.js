...
(function() {
  var Admin, Enquiries, Faqs, Settings;
  ...
  Faqs = (function() {
    ...
    Faqs.prototype.updateContent = function(e) {
      var _this = this;
      e.preventDefault();
      this.spinner.show();
      return $.ajax({
        ...
        success: function(data) {
          _this.spinner.hide();
          return _this.form.find('button').text("Done");
        }
      });
    };
    ...
    Faqs.prototype.fixHelperModified = function(e, tr) {
      ...
      $helper.children().each(function(index) {
        return $(this).width($originals.eq(index).width()).css("background-color", "#fc0").css("border-bottom", "1px solid #dddddd");
      });
      return $helper;
    };
